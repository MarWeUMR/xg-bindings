...
mod tests {
    ...
    #[test]
    fn increment() {
        let dmat_train = DMatrix::load("boston.csv?format=csv").unwrap();
        let dmat_test = DMatrix::load("boston.csv?format=csv").unwrap();
    ...
    //
    //         let features = FeatureMap::from_file("xgboost-bib/xgboost/demo/data/featmap.txt")
